...
# Version: 3.1 (With Telegram Support)
#===============================================================================
...
function Show-MainMenu {
    ...
    Write-Host "   [3] Install Telegram Desktop" -ForegroundColor Magenta
...
function Install-Telegram {
    ...
    Write-Host "Installing Telegram Desktop..." -ForegroundColor Yellow
    Write-Host ""

    try {
        # Try winget first
        $telegramId = "Telegram.TelegramDesktop"
        Write-Host "Attempting to install via Winget..." -ForegroundColor Cyan
        winget install $telegramId --accept-source-agreements --accept-package-agreements --silent
        ...
        Write-Host ""
        Write-Host "[ERROR] Failed to install Telegram Desktop!" -ForegroundColor Red
        Write-Host $_.Exception.Message -ForegroundColor Red
        Write-Host ""
        Write-Host "Please download manually from: https://telegram.org/dl/desktop/win64" -ForegroundColor Yellow
    }
...
do {
    Show-MainMenu
    $menuChoice = Read-Host "Enter your choice (1-5)"
